    ...
    fromMulterStream(readStream, request, file) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => {
                ...
                const emitFile = (f) => {
                    const storedFile = {
                        id: f && f._id ? f._id : null,
                        filename: f && f.filename ? f.filename : null,
                        metadata: f && f.metadata ? f.metadata : null,
                        bucketName: streamOptions.bucketName,
                        chunkSize: f && f.chunkSize ? f.chunkSize : null,
                        size: f && f.length ? f.length : null,
                        md5: f && f.md5 ? f.md5 : null,
                        uploadDate: f && f.uploadDate ? f.uploadDate : null,
                        contentType: f && f.contentType ? f.contentType : null,
                    };
